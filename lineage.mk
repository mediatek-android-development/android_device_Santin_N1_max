...
# Release name
PRODUCT_RELEASE_NAME := N1_max

# Inherit some common CM stuff.
$(call inherit-product, vendor/cm/config/common_full_phone.mk)

# Inherit device configuration
$(call inherit-product, device/Santin/N1_max/device_N1_max.mk)
$(call inherit-product, device/Santin/N1_max/prop.mk)

TARGET_SCREEN_HEIGHT := 1920
TARGET_SCREEN_WIDTH := 1080

# Device identifier. This must come after all inclusions
PRODUCT_DEVICE := N1_max
PRODUCT_NAME := lineage_N1_max
PRODUCT_BRAND := Santin
PRODUCT_MODEL := Santin_N1_max
PRODUCT_MANUFACTURER := Santin

# Google client ID property.
PRODUCT_GMS_CLIENTID_BASE := android-tplink

PRODUCT_BUILD_PROP_OVERRIDES += \
    BUILD_FINGERPRINT=Neffos/TP908A/N1:7.1.1/N4F26M/2371:user/release-keys \
    PRIVATE_BUILD_DESC="full_tk6757_66_n1-user 7.1.1 N4F26M 2371 release-keys" 
